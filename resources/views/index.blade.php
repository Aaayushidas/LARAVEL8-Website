...
@section('content')
    ...
    <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b border-gray-200">
        <div>
            <img src="https://media.istockphoto.com/photos/reading-book-picture-id508586144?b=1&k=6&m=508586144&s=170667a&w=0&h=5J0tC1xPa8VBf4QyzLQ8RuEgwcNH6UYq85plvoVTwtg=" width="700" alt="">
        </div>
